package com.qbin.crawlers.weixin.service.impl;

import com.alibaba.fastjson.JSONObject;
import com.blade.kit.http.*;
import com.blade.kit.json.JSONArray;
import com.blade.kit.json.JSONKit;
import com.qbin.crawlers.cache.service.RedisTemplate;
import com.qbin.crawlers.cache.util.SerializeUtil;
import com.qbin.crawlers.common.globalconst.WeiXinConst;
import com.qbin.crawlers.common.util.*;
import com.qbin.crawlers.common.util.HttpRequest;
import com.qbin.crawlers.schedule.job.WeixinSyncSchedule;
import com.qbin.crawlers.schedule.util.QuartsUtil;
...
public class WeiXinServiceImpl implements WeiXinService{
    ...
    public WeiXinInfo getQRCode() {
        ...
        String QRCode = HttpRequest.dowmImg(url_login);
    ...
    public WeiXinInfo login(WeiXinInfo info) throws Exception{
        ...
        info.setCookie(HttpRequest.getCookie(request));
...
//        String friendsList = HttpRequest.sendPost(contactListUrl, WeiXinUtil.getPostString(info));
...
//        String friendsList = HttpRequest.sendPost(qunListUrl, WeiXinUtil.getPostString(info));
